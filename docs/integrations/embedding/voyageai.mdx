...
- voyage-4-nano (most compact, 1024 default dimensions, supports 256/512/1024/2048)
- voyage-code-4 (optimized for code retrieval, 1024 default dimensions, supports 256/512/1024/2048)
...
|---|---|--------|---------|
| `name` | `str` | `None` | The model ID of the model to use. Supported models: voyage-4-large, voyage-4, voyage-4-lite, voyage-4-nano, voyage-code-4, voyage-3, voyage-3-lite, voyage-3.5, voyage-3.5-lite, voyage-context-4, voyage-context-3, voyage-finance-2, voyage-multilingual-2, voyage-law-2, voyage-code-2, voyage-multimodal-3.5 |
